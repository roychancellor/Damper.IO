...
GRANT EXECUTE ON FUNCTION damper.integration_get_by_id(bigint) TO :"runtime_user";
GRANT EXECUTE ON FUNCTION damper.integration_get_by_api_key_hash(bytea) TO :"runtime_user";
GRANT EXECUTE ON FUNCTION damper.integration_get_all() TO :"runtime_user";

GRANT EXECUTE ON FUNCTION damper.integration_insert(text, boolean, bytea, jsonb) TO :"runtime_user";

GRANT EXECUTE ON FUNCTION damper.integration_update(bigint, text, boolean, bytea, jsonb) TO :"runtime_user";

GRANT EXECUTE ON FUNCTION damper.integration_delete(bigint) TO :"runtime_user";
